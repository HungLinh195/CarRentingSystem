...
public interface RentalService {
    BigDecimal calculateTotalRevenue(List<CarRental> rentals);
    ...
    List<CarRental> createRentals(Integer customerId, String carIdsStr, String pickupDateStr, String returnDateStr);
    ...
    List<Integer> getReviewedRentalIds(Integer customerId);
}
